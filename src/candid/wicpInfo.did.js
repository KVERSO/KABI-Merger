export const idlFactory = ({ IDL }) => {
  ...
  const Token = IDL.Service({
    ...
    batchTransfer: IDL.Func([IDL.Vec(IDL.Principal), IDL.Vec(IDL.Nat)], [TxReceipt], []),
    batchTransferFrom: IDL.Func([IDL.Principal, IDL.Vec(IDL.Principal), IDL.Vec(IDL.Nat)], [TxReceipt], []),
    ...
    getAllBalance: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
    getAllMintInfo: IDL.Func([], [IDL.Vec(IDL.Tuple(BlockHeight__1, MintInfo))], ['query']),
    ...
    getMintBlockInfo: IDL.Func([], [IDL.Vec(IDL.Tuple(BlockHeight__1, IDL.Bool))], ['query']),
    ...
    getWithDrawRecord: IDL.Func([IDL.Nat, IDL.Nat], [IDL.Vec(WithDrawRecord)], ['query']),
    getWithDrawRecordByIndex: IDL.Func([IDL.Nat], [IDL.Opt(WithDrawRecord)], ['query']),
